...
I just came with that term, not that I am trying. But maybe it will mean something someday.
...
Aunque pongamos "porque lo hacemos" segundo, para igualar a la estrcutura del comic. Hay una razón detrás de las cosas (eso es lo que llamamos nuestro `objetivo`).
